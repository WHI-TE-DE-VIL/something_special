"""
Django settings for something_special project.
...
SECRET_KEY = 'django-insecure-c7a-7+y#*8)t=ku+d42lak@6k(5^*3!(_lx73t)$i32y@tyuqm'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'somethingspecial-six.vercel.app',
    '.vercel.app',            # Allows all vercel preview deployments
    '127.0.0.1',              # Keeps local development working
    'localhost',
]
...
ROOT_URLCONF = 'something_special.urls'
...
WSGI_APPLICATION = 'something_special.wsgi.application'
